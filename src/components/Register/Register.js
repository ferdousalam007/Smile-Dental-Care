...
const Register = () => {
    const { handleOnSubmit, handleEmailChange, handlePasswordChange, error } = useAuth();
    return (
        <div className="login-form">
            <div className="bg-blue-200 flex">
                <div className="flex-col flex ml-auto mr-auto items-center w-full lg:w-2/3 md:w-3/5">
                    ...
                    <form onSubmit={handleOnSubmit} className="mt-2 flex flex-col lg:w-1/2 w-8/12">
                        ...
                        <button type="submit" className="bg-blue-400 py-4 text-center px-17 md:px-12 md:py-4 text-white rounded leading-tight text-xl md:text-base font-sans mt-4 mb-20"
                        > Register
                        </button>
                    </form>
