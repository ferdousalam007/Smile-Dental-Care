                ...
                <footer className="flex flex-wrap items-center justify-between p-3 m-auto">
                    <div className="container mx-auto flex flex-col flex-wrap items-center justify-between">
                        <ul className="flex mx-auto text-white text-center">
                            <li className="p-2 cursor-pointer hover:underline"><Link to="/" className="px-3 py-4 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75">Home</Link></li>
                            <li className="p-2 cursor-pointer hover:underline"><Link to="/" className="px-3 py-4 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75">Login</Link></li>
                        </ul>
                        <ul className="flex mx-auto text-white text-center">
                        ...
                        <div className="flex mx-auto text-white text-center">
                            Copyright Smile dental care Clinik © 2021
                        </div>
                    </div>
                </footer>
            </div>
